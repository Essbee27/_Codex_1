# LLM Compare Frontend (Mock Data)

Production-quality **frontend-only** Next.js app for searching, comparing, filtering, and estimating cost across large language models.
